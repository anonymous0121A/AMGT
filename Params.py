...
def ParseArgs():
	...
	parser.add_argument('--gat_layer', default=1, type=int, help='number of gat layers')
	...
	parser.add_argument('--temp', default=0.1, type=float, help='temperature factor in contrastive learning')
	parser.add_argument('--std', default=1, type=float, help='standard deviation in noise generation')
